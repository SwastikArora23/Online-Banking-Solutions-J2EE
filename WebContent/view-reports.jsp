...
String sql = "SELECT accno, operation, amt, balance, time1 FROM tx_details WHERE uname='"+uname+"'";
...
<p>&nbsp;</p>	</td>
	...
	<form id="form1" name="form1" method="post" action="get-balance-fanal.jsp">
	  <table width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <th colspan="5" bgcolor="#333333" scope="col"><font color="#FFFFFF">Following are the Logs of Your Acount(s). </font></th>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
          </tr>
