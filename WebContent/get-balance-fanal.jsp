...
<p>&nbsp;</p>	</td>
	...
	<form id="form1" name="form1" method="post" action="">
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td colspan="3">&nbsp;If you want to Deposit then <a href="deposite.jsp">Click Here</a><br/> Or For Withdrow the Ammount fro Your Account <a href="withdraw.jsp">Click here</a></td>
          </tr>
        <tr>
          <td width="43%">&nbsp;</td>
          <td width="2%">&nbsp;</td>
