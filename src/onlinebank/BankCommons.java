...
public class BankCommons {
	...
	public static String db_pwd = "swastik123";
	public static String db_schema = "bankingsystem";
	public static String db_url = "jdbc:mysql://" + db_host + "/" + db_schema;
	...
	// public static void main (String[] args) {
	// String
	// sql="select ac.acc_no, max(tx.balance) from tx_details tx, acc_details ac where ac.uname = tx.uname  and tx.uname='tousif'";
